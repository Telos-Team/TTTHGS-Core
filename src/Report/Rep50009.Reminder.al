report 50009 "TTTHGS Reminder"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/Report/Rep50009.Reminder.rdl';
    Caption = 'HGS Reminder';
    ...
    dataset
    {
        dataitem("Issued Reminder Header"; "Issued Reminder Header")
        {
            ...
            column(FIK; cuSalesMgt.GetFIK71Remind("Issued Reminder Header"))
            {
            }
            dataitem("Integer"; "Integer")
            {
                ...
                column(CurrReportPageNo; StrSubstNo(Text002Lbl, 0))
                {
                }
                ...
                dataitem(VATCounterLCY; "Integer")
                {
                    ...
                    begin
                        ...
                        if CustEntry.FindFirst() then begin
                            ...
                            VALExchRate := StrSubstNo(Text013Lbl, Round(1 / CurrFactor * 100, 0.000001), CurrExchRate."Exchange Rate Amount");
                        end else begin
            ...
            begin
                ...
                if "Currency Code" = '' then begin
                    ...
                    TotalText := StrSubstNo(Text000Lbl, GLSetup."LCY Code");
                    TotalInclVATText := StrSubstNo(Text001Lbl, GLSetup."LCY Code");
                end else begin
                    TotalText := StrSubstNo(Text000Lbl, "Currency Code");
                    TotalInclVATText := StrSubstNo(Text001Lbl, "Currency Code");
                end;
                //CurrReport.PageNo := 1;
    ...
    var
        ...
        Text000Lbl: Label 'Total %1';
        Text001Lbl: Label 'Total %1 Incl. VAT';
        Text002Lbl: Label 'Page %1';
        ...
        Text013Lbl: Label 'Exchange rate: %1/%2';
