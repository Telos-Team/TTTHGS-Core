report 50007 "TTTHGS StandardStatement"
{
    RDLCLayout = './src/Report/Rep50007.StandardStatement.rdl';
    WordLayout = './src/Report/Rep50007.StandardStatement.docx';
    Caption = 'HGS Standard Statement';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            column(FIK; cuSalesMgt.GetFIK71Cust(Customer))
            {
            }
