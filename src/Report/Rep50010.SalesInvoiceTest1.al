report 50010 "TTTHGS SalesInvoiceTest1"
{
    // version NAVW113.02

    //RDLCLayout = './Rep50010.SalesInvoice.rdl';
    //WordLayout = './Rep50010.SalesInvoiceBlue.docx';
    Caption = 'HGS Sales - Invoice Test1';
    //DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(DeliveryAddress1; DeliveryAddr[1])
            {
            }
            column(DeliveryAddress2; DeliveryAddr[2])
            {
            }
            column(DeliveryAddress3; DeliveryAddr[3])
            {
            }
            column(DeliveryAddress4; DeliveryAddr[4])
            {
            }
            column(DeliveryAddress5; DeliveryAddr[5])
            {
            }
            column(DeliveryAddress6; DeliveryAddr[6])
            {
            }
            column(DeliveryAddress7; DeliveryAddr[7])
            {
            }
            column(DeliveryAddress8; DeliveryAddr[8])
            {
            }
    ...
    var
        ...
        DeliveryAddr: array[8] of Text[90];
    ...
    begin
        ...
        EXIT(copystr(SalesInvoiceLbl, 1, 250));
    end;
